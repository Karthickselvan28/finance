...
import { Area, AreaChart, Bar, CartesianGrid, ComposedChart, Line, XAxis, YAxis, Brush } from "recharts";
        ...
        <div>
          ...
          <ChartContainer config={{}} className="min-h-[400px] w-full">
            <ComposedChart data={amortizationData}>
              ...
              <Bar dataKey="principal_paid" stackId="a" fill="#8884d8" yAxisId="left"/>
              <Bar dataKey="interest_paid" stackId="a" fill="#82ca9d" yAxisId="left"/>
              <Line type="monotone" dataKey="ending_balance" stroke="#ff7300" yAxisId="right"/>
        ...
        <div>
          ...
          <ChartContainer config={{}} className="min-h-[400px] w-full">
            <AreaChart data={investmentData}>
              ...
              <YAxis />
              <ChartTooltip content={<ChartTooltipContent />} />
              <Area type="monotone" dataKey="investment_value" stroke="#82ca9d" fill="#82ca9d" />
              <Brush dataKey="month" height={30} stroke="#8884d8" />
            </AreaChart>
          </ChartContainer>
        </div>
